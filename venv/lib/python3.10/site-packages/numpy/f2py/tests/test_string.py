...
class TestString(util.F2PyTest):
    sources = [util.getpath("tests", "data_pipeline", "string", "char.f90")]
...
class TestDocStringArguments(util.F2PyTest):
    sources = [util.getpath("tests", "data_pipeline", "string", "string.f")]
...
class TestFixedString(util.F2PyTest):
    sources = [util.getpath("tests", "data_pipeline", "string", "fixed_string.f90")]
