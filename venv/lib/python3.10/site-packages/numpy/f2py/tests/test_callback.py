...
class TestF77Callback(util.F2PyTest):
    sources = [util.getpath("tests", "data_pipeline", "callback", "foo.f")]
...
class TestF90Callback(util.F2PyTest):
    sources = [util.getpath("tests", "data_pipeline", "callback", "gh17797.f90")]
...
class TestGH18335(util.F2PyTest):
    ...
    other tests!
    """
    sources = [util.getpath("tests", "data_pipeline", "callback", "gh18335.f90")]
