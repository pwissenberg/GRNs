...
class TestNoSpace(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "data_pipeline", "crackfortran", "gh15035.f")]
...
class TestPublicPrivate:
    def test_defaultPrivate(self):
        fpath = util.getpath("tests", "data_pipeline", "crackfortran", "privatemod.f90")
    ...
    def test_defaultPublic(self, tmp_path):
        fpath = util.getpath("tests", "data_pipeline", "crackfortran", "publicmod.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
        mod = mod[0]
        assert "private" in mod["vars"]["a"]["attrspec"]
    ...
    def test_access_type(self, tmp_path):
        fpath = util.getpath("tests", "data_pipeline", "crackfortran", "accesstype.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
        tt = mod[0]['vars']
...
class TestModuleProcedure():
    def test_moduleOperators(self, tmp_path):
        fpath = util.getpath("tests", "data_pipeline", "crackfortran", "operators.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
        mod = mod[0]
...
class TestExternal(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "data_pipeline", "crackfortran", "gh17859.f")]
...
class TestCrackFortran(util.F2PyTest):
    ...
    sources = [util.getpath("tests", "data_pipeline", "crackfortran", "gh2848.f90")]
...
class TestModuleDeclaration:
    def test_dependencies(self, tmp_path):
        fpath = util.getpath("tests", "data_pipeline", "crackfortran", "foo_deps.f90")
        mod = crackfortran.crackfortran([str(fpath)])
        assert len(mod) == 1
