...
def hello_world_f90(tmpdir_factory):
    ...
    fdat = util.getpath("tests", "data_pipeline", "cli", "hiworld.f90").read_text()
...
def hello_world_f77(tmpdir_factory):
    ...
    fdat = util.getpath("tests", "data_pipeline", "cli", "hi77.f").read_text()
...
def retreal_f77(tmpdir_factory):
    """Generates a single f77 file for testing"""
    fdat = util.getpath("tests", "data_pipeline", "return_real", "foo77.f").read_text()
