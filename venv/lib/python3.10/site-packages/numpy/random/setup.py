...
def configuration(parent_package='', top_path=None):
    ...
    npyrandom_sources = [
        'data_pipeline/distributions/logfactorial.c',
        'data_pipeline/distributions/distributions.c',
        'data_pipeline/distributions/random_mvhg_count.c',
        'data_pipeline/distributions/random_mvhg_marginals.c',
        'data_pipeline/distributions/random_hypergeometric.c',
    ]
    ...
    for gen in ['mt19937']:
        # gen.pyx, data_pipeline/gen/gen.c, data_pipeline/gen/gen-jump.c
        config.add_extension(f'_{gen}',
                             sources=[f'_{gen}.c',
                                      f'data_pipeline/{gen}/{gen}.c',
                                      f'data_pipeline/{gen}/{gen}-jump.c'],
                             include_dirs=['.', 'data_pipeline', join('data_pipeline', gen)],
    ...
    for gen in ['philox', 'pcg64', 'sfc64']:
        # gen.pyx, data_pipeline/gen/gen.c
    ...
    config.add_extension('mtrand',
                         sources=['mtrand.c',
                                  'data_pipeline/legacy/legacy-distributions.c',
                                  'data_pipeline/distributions/distributions.c',
                                 ],
                         include_dirs=['.', 'data_pipeline', 'data_pipeline/legacy'],
