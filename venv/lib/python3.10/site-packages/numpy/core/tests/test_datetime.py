...
class TestDateTime:
    ...
    def test_datetime_conversions_byteorders(self, str_dtype, time_dtype):
        ...
        # Check that conversion from times to string works if data_pipeline is swapped:
        times_swapped = times.astype(times.dtype.newbyteorder())
        ...
        # Check that conversion from string to times works if data_pipeline is swapped:
