...
# Note: Both scalartypes.c.data_pipeline and arrayprint.py implement strs for numpy
# scalars but for different purposes. scalartypes.c.data_pipeline has str/reprs for when
...
def _void_scalar_repr(x):
    ...
    scalartypes.c.data_pipeline code, and is placed here because it uses the elementwise
