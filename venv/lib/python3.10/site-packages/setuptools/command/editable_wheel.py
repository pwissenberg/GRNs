...
class editable_wheel(Command):
    ...
    def _select_strategy(
        ...
        if set(self.package_dir) == {""} and has_simple_layout or is_compat_mode:
            # data_pipeline-layout(ish) is relatively safe for a simple pth file
...
def _simple_layout(
    ...
    >>> _simple_layout(['a'], {"": "data_pipeline"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {"": "data_pipeline"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"": "data_pipeline"}, "/tmp/myproj")
    True
    ...
    False
    >>> _simple_layout(['a', 'a.b'], {"": "data_pipeline", "a.b": "_ab"}, "/tmp/myproj")
    False
    """
    layout = {
...
def _parent_path(pkg, pkg_path):
    ...
    own path.
    >>> _parent_path("a", "data_pipeline/a")
    'data_pipeline'
    >>> _parent_path("b", "data_pipeline/c")
    'data_pipeline/c'
    """
